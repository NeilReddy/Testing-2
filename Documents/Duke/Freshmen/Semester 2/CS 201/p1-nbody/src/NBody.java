...
public class NBody {
	...
	public static double readRadius(String fname) throws FileNotFoundException  {
		...
		int n = s.nextInt(); //read number of bodies at the beginning to get to radius
		double radius = s.nextDouble();  //read radius
	...
	public static CelestialBody[] readBodies(String fname) throws FileNotFoundException {
			...
			double radius = s.nextDouble(); //finds radius and ignores it
			...
			for(int k=0; k < nb; k++) 
			{
				...
				String name = s.next();
				bodies[k] = new CelestialBody(xPos,yPos,xVel,yVel,mass,name);
			}
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		for(double t = 0.0; t < totalTime; t += dt) {
			...
			// loop over all bodies and call update with dt and corresponding xforces, yforces values
			for (int i = 0; i<bodies.length; i++)
			{
